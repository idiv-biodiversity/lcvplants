...
```{r example_data}
set.seed(1)
sps <- tab_lcvp[sample(1:nrow(tab_lcvp), 100), 1]
...
In other words, if you want to run your code using 3 cores, you should divide the total dataset into 3 subsets, and then run `lcvp_search` in 3 parallel cores. Use the following code to dive your dataset.
