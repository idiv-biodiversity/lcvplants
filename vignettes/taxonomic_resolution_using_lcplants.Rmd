...
By default `LCVP` will only use fuzzy matching for the species epitheton, infra-specific names and the authorities. If you want to include the genus name, use the `genus_search` argument.
